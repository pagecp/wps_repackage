...
# -*- coding: utf-8 -*-
#
# wps_repackage documentation build configuration file, created by
...
# Add wps_repackage to sys.path to avoid having to full
# install wps_repackage for autodoc.
# Full install of wps_repackage will burst memory limit on ReadTheDocs.
...
project = "wps_repackage"
copyright = "2020, Christian Page"
...
htmlhelp_basename = "wps_repackagedoc"
